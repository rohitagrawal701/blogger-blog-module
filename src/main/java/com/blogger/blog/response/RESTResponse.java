package com.blogger.blog.response;
...
import com.blogger.blog.configuration.listener.ApplicationContextListener;
import com.blogger.blog.constant.BlogConstants;
import com.blogger.blog.util.AppProperties;
import com.blogger.blog.util.AppUtil;
import com.blogger.blog.util.ResourceBundleUtil;
...
public class RESTResponse {
    ...
    public static RESTResponse ok(final Object data, final String infoMsg) {
        return new RESTResponse(data,
                status(BlogConstants.SUCCESS_CODE, getInfoMessage(infoMsg)));
    }
    ...
    public static RESTResponse ok(final Object data) {
        if (data instanceof Collection<?>
            ...
            return new RESTResponse(status(BlogConstants.SUCCESS_CODE,
                    getInfoMessage(BlogConstants.RECORDS_NOT_FOUND)));
        } else {
        ...
        return new RESTResponse(data, status(BlogConstants.SUCCESS_CODE,
                getInfoMessage(BlogConstants.SUCCESS)));
    }
    ...
    private static String getInfoMessage(final String infoMsg) {
        ...
        return ResourceBundleUtil.getLocalizedMessage(
                "com/blogger/module/blog/messages/info/info", infoMsg,
