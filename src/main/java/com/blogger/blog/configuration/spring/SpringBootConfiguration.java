package com.blogger.blog.configuration.spring;
...
@ComponentScan(basePackages = {"com.blogger.blog"})
@EntityScan(basePackages = {"com.blogger.blog.document"})
@EnableMongoRepositories(basePackages = {"com.blogger.blog.repository"})
